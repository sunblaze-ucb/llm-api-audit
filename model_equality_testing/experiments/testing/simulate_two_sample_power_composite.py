"""
Simulate power of a two-sample test.
"""

from model_equality_testing.dataset import load_distribution
from experiments.testing.simulation import get_power_two_sample_composite_null
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="fp32",
        help="Source to use as the null distribution P1",
    )
    parser.add_argument(
        "--null_distribution_2_source",
        type=str,
        default="fp32",
        help="Source to use as the null distribution P2",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--stat", type=str, default="two_sample_L2", help="Two-sample test statistic"
    )
    parser.add_argument(
        "--pvalue_type",
        type=str,
    ...
    parser.add_argument(
        "--bootstrap_dir", type=str, default="../cache/parametric_bootstrap_stats"
    )
    ...
    p1 = load_distribution(
        ...
        prompt_ids=js,
        L=args.L,
        source=args.null_distribution_1_source,
    ...
    p2 = load_distribution(
        ...
        prompt_ids=js,
        L=args.L,
        source=args.null_distribution_2_source,
        load_in_unicode=args.test_in_unicode,
    )
    print("Null shape: ", p1.shape, p2.shape)
    ...
    filename_stem = build_cache_filename(
        ...
        alternative=(
            args.null_distribution_1_source,
            args.null_distribution_2_source,
        ),
    ...
    filename = filename_stem.format(n1=args.n1, n2=args.n2)
    ...
    if args.pvalue_type == "parametric_bootstrap":
        fn1 = filename_stem.replace(
            f"{args.null_distribution_1_source}_{args.null_distribution_2_source}",
            args.null_distribution_1_source,
        )
        bootstrap_manager_1 = BootstrapManager(
            bootstrap_path_template=f"{args.bootstrap_dir}/{fn1}.pkl",
            min_b=args.min_b,
            max_b=args.max_b,
        )
        get_pvalue_1 = bootstrap_manager_1.load(n1=args.n1, n2=args.n2)
        fn2 = filename_stem.replace(
            f"{args.null_distribution_1_source}_{args.null_distribution_2_source}",
            args.null_distribution_2_source,
        )
        bootstrap_manager_2 = BootstrapManager(
            bootstrap_path_template=f"{args.bootstrap_dir}/{fn2}.pkl",
            min_b=args.min_b,
            max_b=args.max_b,
        )
        get_pvalue_2 = bootstrap_manager_2.load(n1=args.n1, n2=args.n2)
    ...
    (
        ...
        pvalue_history,
        test_stats,
    ) = get_power_two_sample_composite_null(
        p1,
        p2,
        q,
        n_null=args.n1,
        ...
        stat_type=args.stat,
        get_pvalue_fn_1=get_pvalue_1,
        get_pvalue_fn_2=get_pvalue_2,
        return_pvalue=True,
        return_alpha=True,
        return_stat=True,
        alpha=args.alpha,
